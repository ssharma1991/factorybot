#include "ros/ros.h"
#include "factorybot_ball_chaser/DriveToTarget.h"
...
{
    factorybot_ball_chaser::DriveToTarget srv;
...
int main(int argc, char** argv)
{
    ...
    client = n.serviceClient<factorybot_ball_chaser::DriveToTarget>("/ball_chaser/command_robot");
